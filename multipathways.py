...
class DrugBank:
    def __init__(self):
        # con = connector.connect(host = 'cdata.rivan.in',
        #                              port = '3306',
        #                              user = 'rishab_rivan',
        #                              password = 'Rishab@159',
    ...
    def next_page(self, n_url):
        try:
            ...
            query = "insert into Pathways_csv(description, smpd_category, created, last_updated, sub_category, \
                 svg_url, References_text, Time_stamp) values ('"+description+"', '"+smpd_category+"', '"\
